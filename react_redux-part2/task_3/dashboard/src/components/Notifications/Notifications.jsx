...
const Notifications = memo(function Notifications() {
  ...
  const handleToggleDrawer = () => {
    if (DrawerRef.current) {
      const currentClass = DrawerRef.current.className;
      if (currentClass === css(styles.notificationItems, styles.visible)) {
      ...
      >
        {loading ? (
          ...
          <>
            ...
            <button onClick={handleSetFilterUrgent} aria-label="Filter urgent notifications">
              ‼️
            </button>
            <button onClick={handleSetFilterDefault} aria-label="Filter default notifications">
              ❓
            </button>
